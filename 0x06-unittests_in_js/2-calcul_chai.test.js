...
describe("calculateNumber", () => {
    it("Two integers", () => expect(calculateNumber('SUM', 2.2, 2)).to.not.equal(0));
    it("Two integers", () => expect(calculateNumber('SUM', 2.2, 2)).to.not.equal(0));
    it("Two integers", () => expect(calculateNumber('SUM', 2.2, 10.9)).to.deep.equal(13));
    it("Subtraction", () => expect(calculateNumber('SUBTRACT', 4, 3.3)).to.equal(1));
    it("Subtraction", () => expect(calculateNumber('SUBTRACT', 2, 5.3)).to.not.equal(4));
    ...
    it("Division of Integers", () => expect(calculateNumber('DIVIDE', 4, 3.7)).to.not.equal(8));
    ...
    it("Division of Integers", () => expect(calculateNumber('DIVIDE', 45.2, 2)).to.not.equal(45));
